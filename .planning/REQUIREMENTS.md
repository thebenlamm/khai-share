...
- [ ] **WATCH-01**: User can define a watch: site + account + URL + CSS selector (optional) + schedule (cron expression)
- [ ] **WATCH-02**: Watches run on schedule, logging into the site and capturing page content/screenshots
- [ ] **WATCH-03**: Change detection compares current snapshot to previous — content diff and/or visual diff
- [ ] **WATCH-04**: Watch fires webhook notification when a change is detected
- [ ] **WATCH-05**: User can list, create, update, and delete watches via REST API
- [ ] **WATCH-06**: Watch history stores snapshots and change events for review
- [ ] **WATCH-07**: MCP tools expose watch management (list, create, delete, get results)

### HAR Export

- [ ] **HAR-01**: User can enable HAR recording for any action session via parameter
- [ ] **HAR-02**: HAR capture records all network requests/responses via CDP during the session
- [ ] **HAR-03**: HAR files are saved to disk and retrievable via REST API endpoint
...
| WATCH-01 | Phase 18 | Pending |
| WATCH-02 | Phase 18 | Pending |
| WATCH-03 | Phase 18 | Pending |
| WATCH-04 | Phase 18 | Pending |
| WATCH-05 | Phase 18 | Pending |
| WATCH-06 | Phase 18 | Pending |
